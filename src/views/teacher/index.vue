<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="创建时间" type="date" width="270px" align="center" value-format="yyyy-MM-dd HH:mm:ss">
        <template slot-scope="{row}">
...
<script>
import { fetchList, fetchPv, createArticle, updateArticle, deleteUser } from '@/api/teacher'
  ...
  data() {
    return {
      ...
      rules: {
        ...
        position: [{ required: true, message: '职位必须输入', trigger: 'change' }],
