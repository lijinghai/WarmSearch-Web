...
<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="物品点击量" width="120px" align="center">
        <template slot-scope="{row}">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="110px" style="width: 400px; margin-left:150px;">
        ...
        <el-form-item :label="$t('图片')" prop="fimg">
...
<script>
import { fetchList, fetchPv, createArticle, updateArticle, deleteUser } from '@/api/sFind'
